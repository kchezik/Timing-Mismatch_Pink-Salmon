...
Spatial structure plays a pivotal role in controling which habitats respond similarly to climate change. Our study demonstrates that habitats near the estuary track the esturine climate more closely than habitats further away (Figures $\ref{fig:mismatch}$, S1). Freshwater temperature is controled largely by local natal stream climate which in turn contributes to pink salmon fry phenology. For instance, the more extreme thermal variation of the lower interior of British Columbia (BC) relative to the more temperate lower coastal region of BC, results in faster accumulation of thermal time, fewer days of gestation (Figure $\ref{fig:emerg}$) and a wider range of emergence dates (e.g., Figure $\ref{fig:distrib}$). As a result, we estimate pink salmon peak emergence above Hells Gate is on average 13 days earlier than populations below the Canyon and nearly twice as variable. Therefore, pink salmon near the estuary are on average 1.3 times more likely than those in the Thompson and Nicola River region to overlap with the zooplankton bloom and over twice as likely as theoretical populations in the upper Fraser River basin. On average, 31\% of lower Fraser pink salmon arrive during the zoolplankton bloom, compared with 23\% in the Thompson and Nicola region and finally on 14\% in the upper Fraser basin. 
